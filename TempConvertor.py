...
var1=DoubleVar()
var2=DoubleVar()
label=Label(root,text='TEMPERTURE CONVERTER',font=('Arial',30))
label.pack(side=TOP)
label1=Label(root,text='Tempertuure in Celsius =',font=('Arial',25))
...
label3=Label(root,text='Temperture in Fahrenheit =',font=('Arial',25))
...
label4=Label(root,text='Tempertuure in Fahreneheit =',font=('Arial',25))
label4.place(x=200,y=400)
label5=Label(root,text='Temperture in Celsius =',font=('Arial',25))
label5.place(x=200,y=500)
entry2=Entry(root,font=('Arial',25),textvariable=var2)
entry2.place(x=600,y=400)
label6=Label(root,text='Temperture in Fahrenheit =',font=('Arial',25))
